...
// Realistic demo data only, for UI demonstration. Clearly structured as
// demo content — no real programs are represented here.
export const demoOpportunities = [
  {
    id: 'demo-opp-1',
    type: 'Accelerator',
    region: 'Global (remote-friendly)',
    stage: 'Idea – Prototype',
    sector: 'Technology',
    deadline: 'Rolling applications',
    cost: 'Free to apply',
    description:
      'A 10-week remote accelerator for early-stage founders building their first version of a product, with weekly mentor sessions.',
  },
  {
    id: 'demo-opp-2',
    type: 'Grant',
    ...
    stage: 'Early revenue',
    sector: 'Agriculture',
    deadline: 'Opens quarterly',
    cost: 'Free to apply',
    description:
      'Non-dilutive funding for founders building agricultural tools or services, aimed at teams with early customers or users.',
  },
  {
    id: 'demo-opp-3',
    type: 'Competition',
    ...
    stage: 'Prototype',
    sector: 'Health',
    deadline: 'Deadline in 6 weeks',
    cost: '$15 application fee',
    description:
      'A regional pitch competition for health-focused prototypes, with cash prizes and a mentorship track for finalists.',
  },
  {
    id: 'demo-opp-4',
    type: 'Fellowship',
    ...
    stage: 'Idea',
    sector: 'Creative',
    deadline: 'Deadline in 3 weeks',
    cost: 'Free to apply',
    description:
      'A 12-month fellowship supporting creative founders with a small stipend, a mentor network, and access to a peer community.',
  },
  {
    id: 'demo-opp-5',
    type: 'Training',
    ...
    cost: 'Free',
    description:
      'A self-paced course on turning an idea into a validated project, including how to talk to your first potential users.',
  },
  {
    id: 'demo-opp-6',
    type: 'Mentorship',
    region: 'Middle East & North Africa',
    stage: 'Prototype – Early revenue',
    sector: 'Fashion',
    deadline: 'Rolling applications',
    cost: 'Free',
    description:
      'One-on-one mentorship matching for founders in the fashion and creative goods sector, focused on production and distribution.',
  },
];
...
export const demoMentors = [
  {
    id: 'demo-mentor-1',
    name: 'Demo Mentor — Product',
    skills: ['Product strategy', 'Early-stage validation'],
  ...
  {
    id: 'demo-mentor-2',
    name: 'Demo Mentor — Finance',
    skills: ['Financial planning', 'Grant applications'],
  ...
  {
    id: 'demo-mentor-3',
    name: 'Demo Mentor — Engineering',
    skills: ['Technical architecture', 'No-code tools'],
...
export const demoProject = {
  name: 'Demo project — Community Compost Network',
  problem: 'Neighborhoods with no affordable way to compost household food waste.',
  solution: 'A shared drop-off and pickup network run with local partners.',
  stage: 'Idea',
  targetUsers: 'Renters in dense urban neighborhoods',
  goals: ['Validate demand with 50 households', 'Find one local partner site'],
  milestones: [
    { label: 'Talk to 20 potential users', done: true },
    { label: 'Confirm one pilot location', done: false },
    { label: 'Draft a simple pricing model', done: false },
  ],
  tasks: [
    { label: 'Write a one-page project summary', done: true },
    { label: 'Ask a mentor to review the summary', done: false },
    { label: 'Identify two nearby opportunities', done: false },
  ],
  nextStep: 'Ask a mentor to review your project summary before you approach a partner site.',
  opportunities: 2,
};
