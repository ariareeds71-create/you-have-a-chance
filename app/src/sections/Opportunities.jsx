  ...
  return (
    <section className="section opportunities" id="opportunities">
      <div className="container">
        ...
        <div className="opportunities__grid">{visible.length === 0 ? <p className="opportunities__empty">No verified opportunities are available yet.</p> : visible.map((o) => <OpportunityCard opportunity={o} key={o.id} />)}</div>
